    ...
    <div class="body-wrapper">
        ...
        <div class="body-wrapper-inner">
            <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-md-flex align-items-center">
                                        <div>
                                            <h4 class="card-title">Genel Koşullar</h4>
                                    ...
                                    <div class="table-responsive mt-4">
                                        <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                                            ...
                                            <tbody>
                                            @foreach($general_conditions as $conditions)
                                                <tr>
                                                    <td>{!! nl2br(e($conditions->conditions)) !!}</td>
                                                    <td>
                                                        <a href="{{ route('general_conditions.delete', ['id' => $conditions->id]) }}"
                ...
                @endif
                <div class="row cari-turu-ekle" @if (isset($general_conditions)) style="display:none;" @endif>
                    <form
                        action="{{ isset($general_conditions) ? route('general_conditions.add') : route('general_conditions.update', ['id' => $justAConditions->id]) }}"
                        method="post">
                        @csrf
                        <div class="container">
                            <div class="card">
                                <div class="card-header">
                                    <h3>Genel Koşul Ekle</h3>
                                </div>
                                <div class="card-body">
